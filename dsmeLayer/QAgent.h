...
using QState = State<TimeFeature, QueueFullFeature, OtherQueueFullFeature, SuccessFeature, CCASuccessFeature, OverheardPacketsFeature, SentPacketsFeature, TxSuccessFeature, TxFailedFeature>;
using QFeatureManager = FeatureManager<TimeFeature, QueueFullFeature, OtherQueueFullFeature, SuccessFeature, CCASuccessFeature, OverheardPacketsFeature, SentPacketsFeature, TxSuccessFeature, TxFailedFeature>;
...
class QAgent {
public:
    QAgent(DSMELayer &dsme, float eps=1.0, float eps_min=0.02, float eps_decay=0.99999, float gamma=0.9, float lr=0.1);
